...
export default function MenuntutIlmuScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: 'Hadits Menuntut Ilmu', headerBackTitle: 'Kembali', headerStyle: { backgroundColor: '#059669' }, headerTintColor: '#fff' }} />
      <ImageBackground 
        ...
        <View style={styles.overlay}>
          <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            <View style={styles.contentCard}>
              <Text style={styles.arab}>طَلَبُ الْعِلْمِ فَرِيضَةٌ عَلَى كُلِّ مُسْلِمٍ</Text>
              <View style={styles.divider} />
              <Text style={styles.latin}>Thalabul 'ilmi faridhatun 'ala kulli muslim.</Text>
              <Text style={styles.arti}>"Menuntut ilmu itu wajib bagi setiap muslim."</Text>
            </View>
          </ScrollView>
        </View>
      </ImageBackground>
