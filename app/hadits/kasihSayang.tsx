...
export default function KasihSayangScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: 'Hadits Kasih Sayang', headerBackTitle: 'Kembali', headerStyle: { backgroundColor: '#059669' }, headerTintColor: '#fff' }} />
      <ImageBackground 
        ...
        <View style={styles.overlay}>
          <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            <View style={styles.contentCard}>
              <Text style={styles.arab}>مَنْ لَا يَرْحَمْ لَا يُرْحَمْ</Text>
              <View style={styles.divider} />
              <Text style={styles.latin}>Man laa yarham laa yurham.</Text>
              <Text style={styles.arti}>"Barangsiapa tidak menyayangi, maka tidak akan disayangi."</Text>
            </View>
          </ScrollView>
        </View>
      </ImageBackground>
