...
export default function SebelumTidurScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: 'Doa Sebelum Tidur', headerBackTitle: 'Kembali', headerStyle: { backgroundColor: '#059669' }, headerTintColor: '#fff' }} />
      <ImageBackground 
        ...
        <View style={styles.overlay}>
          <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            <View style={styles.contentCard}>
              <Text style={styles.arab}>بِاسْمِكَ اللَّهُمَّ أَمُوتُ وَأَحْيَا</Text>
              <View style={styles.divider} />
              <Text style={styles.latin}>Bismikallahumma amutu wa ahya.</Text>
              <Text style={styles.arti}>"Dengan nama-Mu ya Allah aku mati dan hidup."</Text>
            </View>
          </ScrollView>
        </View>
      </ImageBackground>
