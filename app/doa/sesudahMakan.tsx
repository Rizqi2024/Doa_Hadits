...
export default function SesudahMakanScreen() {
  return (
    <SafeAreaView style={styles.container}>
      <Stack.Screen options={{ title: 'Doa Sesudah Makan', headerBackTitle: 'Kembali', headerStyle: { backgroundColor: '#059669' }, headerTintColor: '#fff' }} />
      <ImageBackground 
        ...
        <View style={styles.overlay}>
          <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
            <View style={styles.contentCard}>
              ...
              <Text style={styles.latin}>Alhamdulillahilladzi ath'amanaa wa saqoonaa wa ja'alanaa muslimiin.</Text>
              <Text style={styles.arti}>"Segala puji bagi Allah yang telah memberi kami makan dan minum, serta menjadikan kami muslim."</Text>
            </View>
          </ScrollView>
        </View>
      </ImageBackground>
